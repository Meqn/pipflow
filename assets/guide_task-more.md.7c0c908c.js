import{_ as s,o as a,c as n,Q as p}from"./chunks/framework.e1e0b12f.js";const u=JSON.parse('{"title":"其他任务","description":"","frontmatter":{},"headers":[],"relativePath":"guide/task-more.md","filePath":"guide/task-more.md","lastUpdated":1703734600000}'),l={name:"guide/task-more.md"},o=p(`<h1 id="more-task" tabindex="-1">其他任务 <a class="header-anchor" href="#more-task" aria-label="Permalink to &quot;其他任务 {#more-task}&quot;">​</a></h1><p>下面是一些辅助任务，用于复制、压缩 和 删除 文件及目录等。</p><h2 id="copy-task" tabindex="-1">copy 复制任务 <a class="header-anchor" href="#copy-task" aria-label="Permalink to &quot;copy 复制任务 {#copy-task}&quot;">​</a></h2><p><code>copy</code> 任务用于复制文件和目录。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// pipflow.config.js</span></span>
